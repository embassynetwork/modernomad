    ...
    return (
      <div className="row">
        ...
        <div className={(this.props.detail ? "col-sm-5" : "col-md-2 col-sm-4")}>
          <DatePicker name="arrive" placeholderText="Arrive" className={(this.props.detail ? "form-control" : "form-control input-lg")} selected={this.state.arrive} onChange={this.changeHandler('arrive')} minDate={moment()} />
        </div>
        <div className={(this.props.detail ? "col-sm-5" : "col-md-2 col-sm-4")}>
          <DatePicker name="depart" placeholderText="Depart" className={(this.props.detail ? "form-control" : "form-control input-lg")} selected={this.state.depart} onChange={this.changeHandler('depart')} minDate={this.minDepart()} />
        </div>
      </div>
    )
  }
