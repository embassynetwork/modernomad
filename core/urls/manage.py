...
urlpatterns = patterns('core.views', 
	...
	url(r'reservation/(?P<reservation_id>\d+)/deletebillitem/$', 'DeleteBillLineItem', name='delete_bill_item'), 
	...
	url(r'reservation/(?P<reservation_id>\d+)/recalculate/$', 'RecalculateBill', name='recalculate_bill'), 
