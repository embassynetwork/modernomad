...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReservationNote'
        db.create_table(u'core_reservationnote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('reservation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reservation_notes', to=orm['core.Reservation'])),
            ('note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['ReservationNote'])


    def backwards(self, orm):
        # Deleting model 'ReservationNote'
        db.delete_table(u'core_reservationnote')
