...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.check_out'
        db.add_column(u'core_location', 'check_out',
                      self.gf('django.db.models.fields.CharField')(default='11am', max_length=20),
                      keep_default=False)

        # Adding field 'Location.check_in'
        db.add_column(u'core_location', 'check_in',
                      self.gf('django.db.models.fields.CharField')(default='2pm', max_length=200),
                      keep_default=False)

        # Adding field 'Location.welcome_email'
        db.add_column(u'core_location', 'welcome_email',
                      self.gf('django.db.models.fields.TextField')(default='Welcome!'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.check_out'
        db.delete_column(u'core_location', 'check_out')

        # Deleting field 'Location.check_in'
        db.delete_column(u'core_location', 'check_in')

        # Deleting field 'Location.welcome_email'
        db.delete_column(u'core_location', 'welcome_email')
    ...
    models = {
        ...
        u'core.location': {
            ...
            'welcome_email': ('django.db.models.fields.TextField', [], {}),
