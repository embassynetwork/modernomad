...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.links'
        db.alter_column('core_userprofile', 'links', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.links'
        db.alter_column('core_userprofile', 'links', self.gf('django.db.models.fields.TextField')(default=''))
