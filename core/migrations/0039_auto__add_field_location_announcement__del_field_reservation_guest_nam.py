...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		# Adding field 'Location.announcement'
		db.add_column(u'core_location', 'announcement',
					  self.gf('django.db.models.fields.TextField')(null=True, blank=True),
					  keep_default=False)

		# Deleting field 'Reservation.guest_name'
		db.delete_column(u'core_reservation', 'guest_name')

		# Deleting field 'Reservation.hosted'
		db.delete_column(u'core_reservation', 'hosted')

	def backwards(self, orm):
		# Deleting field 'Location.announcement'
		db.delete_column(u'core_location', 'announcement')

		# Adding field 'Reservation.guest_name'
		db.add_column(u'core_reservation', 'guest_name',
					  self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
					  keep_default=False)

		# Adding field 'Reservation.hosted'
		db.add_column(u'core_reservation', 'hosted',
