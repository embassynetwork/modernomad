...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reservation.last_nudge'
        db.alter_column('core_reservation', 'last_nudge', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Reservation.last_nudge'
        db.alter_column('core_reservation', 'last_nudge', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'core.reservation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_nudge': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
