...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reconcile.reservation'
        db.alter_column('core_reconcile', 'reservation_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Reservation'], unique=True))
        # Adding unique constraint on 'Reconcile', fields ['reservation']
        db.create_unique('core_reconcile', ['reservation_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Reconcile', fields ['reservation']
        db.delete_unique('core_reconcile', ['reservation_id'])


        # Changing field 'Reconcile.reservation'
        db.alter_column('core_reconcile', 'reservation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Reservation']))
