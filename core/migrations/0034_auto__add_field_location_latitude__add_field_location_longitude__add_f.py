...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_location', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=47.5),
                      keep_default=False)

        # Adding field 'Location.longitude'
        db.add_column(u'core_location', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=121.5),
                      keep_default=False)

        # Adding field 'Location.image'
        db.add_column(u'core_location', 'image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_location', 'image')
