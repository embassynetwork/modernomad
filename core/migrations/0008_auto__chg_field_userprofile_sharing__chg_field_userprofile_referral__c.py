...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_userprofile', 'sharing', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.referral'
        db.alter_column('core_userprofile', 'referral', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'UserProfile.projects'
        db.alter_column('core_userprofile', 'projects', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.discussion'
        db.alter_column('core_userprofile', 'discussion', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'UserProfile.sharing'
        db.alter_column('core_userprofile', 'sharing', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'UserProfile.referral'
        db.alter_column('core_userprofile', 'referral', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'UserProfile.projects'
        db.alter_column('core_userprofile', 'projects', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'UserProfile.discussion'
        db.alter_column('core_userprofile', 'discussion', self.gf('django.db.models.fields.TextField')(null=True))
