...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		# Deleting field 'Location.taxes'
		db.delete_column(u'core_location', 'taxes')

		# Deleting field 'Location.tax_rate'
		db.delete_column(u'core_location', 'tax_rate')

		# Changing field 'Fee.percentage'
		db.alter_column(u'core_fee', 'percentage', self.gf('django.db.models.fields.FloatField')())

	def backwards(self, orm):
		# Adding field 'Location.taxes'
		db.add_column(u'core_location', 'taxes',
					  self.gf('django.db.models.fields.BooleanField')(default=False),
					  keep_default=False)

		# Adding field 'Location.tax_rate'
		db.add_column(u'core_location', 'tax_rate',
					  self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
					  keep_default=False)

		# Changing field 'Fee.percentage'
		db.alter_column(u'core_fee', 'percentage', self.gf('django.db.models.fields.PositiveIntegerField')())
