...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.image_thumb'
        db.add_column('core_userprofile', 'image_thumb',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.image_thumb'
        db.delete_column('core_userprofile', 'image_thumb')
