...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reservable.start_date'
        db.alter_column(u'core_reservable', 'start_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Reservable.end_date'
        db.alter_column(u'core_reservable', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Reservable.start_date'
        db.alter_column(u'core_reservable', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Reservable.end_date'
        db.alter_column(u'core_reservable', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
