...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reservation.accommodation_preference'
        db.delete_column('core_reservation', 'accommodation_preference')


    def backwards(self, orm):
        # Adding field 'Reservation.accommodation_preference'
        db.add_column('core_reservation', 'accommodation_preference',
