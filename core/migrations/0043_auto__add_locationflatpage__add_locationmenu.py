...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocationFlatPage'
        db.create_table(u'core_locationflatpage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('menu', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pages', to=orm['core.LocationMenu'])),
            ('flatpage', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['flatpages.FlatPage'], unique=True)),
        ))
        db.send_create_signal(u'core', ['LocationFlatPage'])

        # Adding model 'LocationMenu'
        db.create_table(u'core_locationmenu', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Location'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'core', ['LocationMenu'])


    def backwards(self, orm):
        # Deleting model 'LocationFlatPage'
        db.delete_table(u'core_locationflatpage')

        # Deleting model 'LocationMenu'
        db.delete_table(u'core_locationmenu')
