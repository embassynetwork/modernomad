...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_reservation', 'hosted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Reservation.guest_name'
        db.add_column('core_reservation', 'guest_name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_reservation', 'hosted')

        # Deleting field 'Reservation.guest_name'
        db.delete_column('core_reservation', 'guest_name')
