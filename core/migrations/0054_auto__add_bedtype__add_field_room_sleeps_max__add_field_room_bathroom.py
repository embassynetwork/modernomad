...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BedType'
        db.create_table(u'core_bedtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['BedType'])

        # Adding field 'Room.sleeps_max'
        db.add_column(u'core_room', 'sleeps_max',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Room.bathroom'
        db.add_column(u'core_room', 'bathroom',
                      self.gf('django.db.models.fields.CharField')(default='shared', max_length=200),
                      keep_default=False)

        # Adding M2M table for field bed_types on 'Room'
        m2m_table_name = db.shorten_name(u'core_room_bed_types')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('room', models.ForeignKey(orm[u'core.room'], null=False)),
            ('bedtype', models.ForeignKey(orm[u'core.bedtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['room_id', 'bedtype_id'])


    def backwards(self, orm):
        # Deleting model 'BedType'
        db.delete_table(u'core_bedtype')

        # Deleting field 'Room.sleeps_max'
        db.delete_column(u'core_room', 'sleeps_max')

        # Deleting field 'Room.bathroom'
        db.delete_column(u'core_room', 'bathroom')

        # Removing M2M table for field bed_types on 'Room'
        db.delete_table(db.shorten_name(u'core_room_bed_types'))
    ...
    models = {
        ...
        u'core.room': {
            ...
            'bathroom': ('django.db.models.fields.CharField', [], {'default': "'shared'", 'max_length': '200'}),
            'bed_types': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['core.BedType']", 'symmetrical': 'False'}),
            ...
            'shared': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sleeps_max': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
        u'core.usernote': {
            'Meta': {'object_name': 'UserNote'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
