...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.projects'
        db.add_column('core_userprofile', 'projects',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'UserProfile.sharing'
        db.add_column('core_userprofile', 'sharing',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'UserProfile.discussion'
        db.add_column('core_userprofile', 'discussion',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'UserProfile.referral'
        db.add_column('core_userprofile', 'referral',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.projects'
        db.delete_column('core_userprofile', 'projects')

        # Deleting field 'UserProfile.sharing'
        db.delete_column('core_userprofile', 'sharing')

        # Deleting field 'UserProfile.discussion'
        db.delete_column('core_userprofile', 'discussion')

        # Deleting field 'UserProfile.referral'
        db.delete_column('core_userprofile', 'referral')
