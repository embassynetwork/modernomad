...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Reservable'
        db.create_table(u'core_reservable', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Room'])),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['Reservable'])

        # Deleting field 'Room.primary_use'
        db.delete_column(u'core_room', 'primary_use')

        # Adding M2M table for field resident on 'Room'
        m2m_table_name = db.shorten_name(u'core_room_resident')
    ...
    def backwards(self, orm):
        # Deleting model 'Reservable'
        db.delete_table(u'core_reservable')

        # Adding field 'Room.primary_use'
        db.add_column(u'core_room', 'primary_use',
                      self.gf('django.db.models.fields.CharField')(default='private', max_length=200),
                      keep_default=False)

        # Removing M2M table for field resident on 'Room'
        db.delete_table(db.shorten_name(u'core_room_resident'))
    ...
    models = {
        ...
        u'core.reservable': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Room']"}),
        ...
        u'core.room': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'resident': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False'}),
            'shared': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'core.userprofile': {
