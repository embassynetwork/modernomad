    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original', models.ImageField(null=True, upload_to=core.models.resource_img_upload_to, blank=True)),
                ('large', models.ImageField(null=True, upload_to=core.models.resource_img_upload_to, blank=True)),
                ('med', models.ImageField(null=True, upload_to=core.models.resource_img_upload_to, blank=True)),
                ('thumb', models.ImageField(null=True, upload_to=core.models.resource_img_upload_to, blank=True)),
