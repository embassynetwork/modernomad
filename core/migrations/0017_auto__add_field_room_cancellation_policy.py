...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Room.cancellation_policy'
        db.add_column('core_room', 'cancellation_policy',
                      self.gf('django.db.models.fields.CharField')(default='24 hours', max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Room.cancellation_policy'
        db.delete_column('core_room', 'cancellation_policy')
