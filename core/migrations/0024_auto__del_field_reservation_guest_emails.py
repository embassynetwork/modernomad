...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reservation.guest_emails'
        db.delete_column('core_reservation', 'guest_emails')


    def backwards(self, orm):
        # Adding field 'Reservation.guest_emails'
        db.add_column('core_reservation', 'guest_emails',
