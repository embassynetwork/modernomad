...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reservation.last_msg'
        db.alter_column('core_reservation', 'last_msg', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Reservation.last_msg'
        db.alter_column('core_reservation', 'last_msg', self.gf('django.db.models.fields.DateField')(null=True))
