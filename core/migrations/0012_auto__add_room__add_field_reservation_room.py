...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Room'
        db.create_table('core_room', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('default_rate', self.gf('django.db.models.fields.IntegerField')()),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('primary_use', self.gf('django.db.models.fields.CharField')(default='private', max_length=200)),
        ))
        db.send_create_signal('core', ['Room'])

        # Adding field 'Reservation.room'
        db.add_column('core_reservation', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Room'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Room'
        db.delete_table('core_room')

        # Deleting field 'Reservation.room'
        db.delete_column('core_reservation', 'room_id')
