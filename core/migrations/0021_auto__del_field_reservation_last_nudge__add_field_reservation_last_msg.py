...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reservation.last_nudge'
        db.delete_column('core_reservation', 'last_nudge')

        # Adding field 'Reservation.last_msg'
        db.add_column('core_reservation', 'last_msg',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Reservation.last_nudge'
        db.add_column('core_reservation', 'last_nudge',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Reservation.last_msg'
        db.delete_column('core_reservation', 'last_msg')
