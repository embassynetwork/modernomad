...
class Migration(DataMigration):
   	...
   	def forwards(self, orm):
		...
		# Note: this 1-1 mapping from reservation to user works easily because
		# when this migration was applied, no user had more than one
		# reservation. would need to be more careful if that was not
		# the case.
	...
	def backwards(self, orm):
		...
		for reservation in orm.Reservation.objects.all():
			...
			reservation.sharing = profile.sharing
			reservation.discussion = profile.discussion
			reservation.referral = profile.referral
			reservation.save()
