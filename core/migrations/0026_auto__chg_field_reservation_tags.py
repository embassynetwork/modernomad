...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reservation.tags'
        db.alter_column('core_reservation', 'tags', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Reservation.tags'
        db.alter_column('core_reservation', 'tags', self.gf('django.db.models.fields.CharField')(default='travel', max_length=200))
