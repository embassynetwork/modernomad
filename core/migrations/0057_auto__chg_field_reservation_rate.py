...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reservation.rate'
        db.alter_column(u'core_reservation', 'rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Reservation.rate'
        db.alter_column(u'core_reservation', 'rate', self.gf('django.db.models.fields.IntegerField')(null=True))
