...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field residents on 'Room'
        m2m_table_name = db.shorten_name(u'core_room_residents')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field residents on 'Room'
        db.delete_table(db.shorten_name(u'core_room_residents'))
