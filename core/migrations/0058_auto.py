...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field suppressed_fees on 'Reservation'
        m2m_table_name = db.shorten_name(u'core_reservation_suppressed_fees')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('reservation', models.ForeignKey(orm[u'core.reservation'], null=False)),
            ('fee', models.ForeignKey(orm[u'core.fee'], null=False))
        ))
        db.create_unique(m2m_table_name, ['reservation_id', 'fee_id'])


    def backwards(self, orm):
        # Removing M2M table for field suppressed_fees on 'Reservation'
        db.delete_table(db.shorten_name(u'core_reservation_suppressed_fees'))
    ...
    models = {
        ...
        u'core.reservation': {
            ...
            'suppressed_fees': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['core.Fee']", 'null': 'True', 'blank': 'True'}),
