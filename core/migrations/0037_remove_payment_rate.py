...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		# Deleting field 'Payment.rate'
		db.delete_column(u'core_payment', 'rate')

		# Changing field 'Payment.paid_amount' to default 0
		db.alter_column(u'core_payment', 'paid_amount', self.gf('django.db.models.fields.IntegerField')())

	def backwards(self, orm):
		# Adding field 'Payment.rate'
		db.add_column(u'core_payment', 'rate',
