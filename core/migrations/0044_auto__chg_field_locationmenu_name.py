...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocationMenu.name'
        db.alter_column(u'core_locationmenu', 'name', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'LocationMenu.name'
        db.alter_column(u'core_locationmenu', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
