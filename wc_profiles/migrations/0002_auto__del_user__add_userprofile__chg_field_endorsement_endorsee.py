...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('wc_profiles_userprofile', (
            ...
            ('invited_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wc_profiles.UserProfile'], null=True, blank=True)),
        ))
        db.send_create_signal('wc_profiles', ['UserProfile'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('wc_profiles_userprofile')


        # Changing field 'Endorsement.endorsee'
        db.alter_column('wc_profiles_endorsement', 'endorsee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wc_profiles.User']))
